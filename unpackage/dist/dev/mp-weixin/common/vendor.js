...
function fetchDel(data) {
  return (0, _http.request)({
    method: 'DELETE',
    url: "/api/article/delete/".concat(data.id),
    data: data });
...
function fetchArticle(data) {
  return (0, _http.request)({
    method: 'GET',
    url: "/api/article/detail/".concat(data.id),
    data: data });
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.request = request;exports.abortTask = abortTask;exports.RES_ROOT = exports.BASE_URL = void 0; // env: testing
// const envVersion = __wxConfig.envVersion
// console.log('envVersion:',envVersion)
// export const BASE_URL = envVersion === 'release' ? 'https://mp.kailunpm.com' : 'https://kailun-se-dev.mallsmart.cn'
...
/**
                     * 网络请求
                     */
function request(params) {var isToken = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
  return new Promise(function (resolve, reject) {
...
/***/ 21:
/*!*********************************************************************!*\
  !*** /Users/chengheai/code/private/write-messages/common/index.css ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.timestampFormat = timestampFormat;exports.requestLogin = requestLogin; // 时间处理
/**
